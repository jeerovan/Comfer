...
- Date-only reminders have a configurable default time, initially 09:00, and can be disabled. Dedicated-channel notifications use a check mark inside a ring as their small icon, including grouped and lock-screen-private versions, and support Complete/Snooze/Open and lock-screen privacy. Snooze changes delivery intent, not due date or recurrence. Dismissal is not completion.
