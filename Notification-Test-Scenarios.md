...
| Layout | Short and tall portrait screens, different densities, landscape, rotation, large text, keyboard | Inbox and launcher settings start at the top in full height. Downward drag at the top reveals reach space capped at the 360 dp bottom area; upward scrolling removes it. Check short-height/landscape zero offset, nested scrolling, fixed bottom controls, wrapping and input/navigation. See docs/thumb-reach.md. |
